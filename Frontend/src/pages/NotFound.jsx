...
const NotFound = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-800/50 p-6 transition-colors duration-300">
      <div className="w-full max-w-lg text-center space-y-8 relative">
        ...
        <div className="relative w-32 h-32 mx-auto flex items-center justify-center">
          ...
          <div className="absolute w-24 h-24 bg-indigo-50 dark:bg-indigo-500/10 border border-slate-200 dark:border-slate-700 rounded-full flex items-center justify-center shadow-inner" />
        ...
        <div className="p-4 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm max-w-sm mx-auto text-sm font-medium text-slate-500 dark:text-slate-400 transition-colors">
