  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700 ease-out">
      ...
      <div
        ...
        className="cursor-pointer bg-white dark:bg-slate-900/90 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm hover:shadow-md hover:border-[#EA580C]/40 dark:hover:border-[#EA580C]/40 transition-all duration-300 hover:-translate-y-1 flex flex-col justify-between group"
      >
        <div className="flex justify-between items-start mb-6">
          ...
          <span className="bg-orange-50 dark:bg-orange-500/10 text-[#EA580C] dark:text-orange-400 border dark:border-slate-700 border-orange-100 dark:border-orange-500/20 text-[11px] px-3 py-1.5 rounded-full font-bold uppercase tracking-wider shadow-sm">
      ...
      <div
        onClick={() => navigate("/invoices")}
        className="cursor-pointer bg-white dark:bg-slate-900/90 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm hover:shadow-md hover:border-indigo-300 dark:hover:border-indigo-800 transition-all duration-300 hover:-translate-y-1 flex flex-col justify-between group"
      >
        <div className="flex justify-between items-start mb-6">
          ...
          <span className="bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 border dark:border-slate-700 border-indigo-100 dark:border-indigo-500/20 text-[11px] px-3 py-1.5 rounded-full font-bold uppercase tracking-wider shadow-sm">
      ...
      <div
        onClick={() => navigate("/invoices")}
        className="cursor-pointer bg-white dark:bg-slate-900/90 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm hover:shadow-md hover:border-amber-300 dark:hover:border-amber-800 transition-all duration-300 hover:-translate-y-1 flex flex-col justify-between group"
      >
        <div className="flex justify-between items-start mb-6">
